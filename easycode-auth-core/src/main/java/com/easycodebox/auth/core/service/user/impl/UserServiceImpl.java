...
import com.easycodebox.common.jdbc.JoinType;
...
public class UserServiceImpl extends AbstractService<User> implements UserService {
	...
	public DataPage<User> page(String groupName, String userNo, String username, 
		...
		return super.page(sql()
				...
				.like(R.Group.name, groupName)
				.like(R.User.userNo, userNo)
				.like(R.User.username, username)
				.like(R.User.nickname, nickname)
				.like(R.User.realname, realname)
				.like(R.User.email, email)
				.like(R.User.mobile, mobile)
