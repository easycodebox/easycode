<header class="main-header">
	...
	<a href="/" class="logo"> 
		...
		<span class="logo-lg"><b>Easy</b>Code</span>
	</a>
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<ul class="menu">
								...
								<li>
									<a href="#"> <i class="fa fa-users text-red"></i> 5new members joined</a>
								</li>
								<li>
				...
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
						<img src="/imgs/frame/avatar.png" class="user-image"> 
					...
					<ul class="dropdown-menu">
						<li class="user-header">
							<img src="/imgs/frame/avatar.png" class="img-circle">
							<p>
								${user_info.nickname} - Web Developer <small>Member since Nov. 2012</small>
							</p>
						</li>
						<!-- Menu Body -->
						<li class="user-body">
						...
						<li class="user-footer">
							<div class="pull-left">
								<a id="updPwdBtn" href="#" class="btn btn-default btn-flat">修改密码</a>
							</div>
