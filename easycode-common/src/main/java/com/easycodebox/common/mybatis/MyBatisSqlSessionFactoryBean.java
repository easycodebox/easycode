package com.easycodebox.common.mybatis;
...
import com.easycodebox.common.jdbc.DefaultXMLConfigBuilder;
...
public class MyBatisSqlSessionFactoryBean implements
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		DefaultXMLConfigBuilder xmlConfigBuilder = null;
		if (this.configLocation != null) {
			xmlConfigBuilder = new DefaultXMLConfigBuilder(
