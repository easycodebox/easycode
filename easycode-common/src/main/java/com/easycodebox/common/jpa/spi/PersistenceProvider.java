...
import com.easycodebox.common.jpa.EntityManagerFactory;
/**
 * Interface implemented by a persistence provider.
 * The implementation of this interface that is to
 * be used for a given {@link com.easycodebox.common.jpa.EntityManager} is specified in
 * persistence.xml file in the persistence archive.
 * This interface is invoked by the Container when it
 * needs to create an {@link com.easycodebox.common.jpa.EntityManagerFactory}, or by the
...
public interface PersistenceProvider {
    ...
    /**
    * Called by Persistence class when an {@link com.easycodebox.common.jpa.EntityManagerFactory}
    * is to be created.
    *
    ...
    */
    ...
    /**
     * Called by the container when an {@link com.easycodebox.common.jpa.EntityManagerFactory}
     * is to be created.
     *
